...
#define CIRCULATING_PUMP_PORT	GPIOE
#define CIRCULATING_PUMP_PIN	GPIO_PIN_10

#define DRAINAGE_PUMP_PORT		GPIOE
#define DRAINAGE_PUMP_PIN		GPIO_PIN_11

#define FILL_VALVE_PORT			GPIOE
#define FILL_VALVE_PIN			GPIO_PIN_12

#define NUTRIENT_SOLN_A_PORT	GPIOE
#define NUTRIENT_SOLN_A_PIN		GPIO_PIN_13

#define NUTRIENT_SOLN_B_PORT	GPIOE
#define NUTRIENT_SOLN_B_PIN		GPIO_PIN_14

#define PH_UP_VALVE_PORT		GPIOE
#define PH_UP_VALVE_PIN			GPIO_PIN_15

#define PH_DOWN_VALVE_PORT		GPIOB
